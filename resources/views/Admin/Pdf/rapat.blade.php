...
<body>
    <table cellpadding="0" cellspacing="0">
        <thead>
            ...
            <tr>
                <td style="vertical-align: middle; " class="text-center"><h3>Sistem Informasi Absensi Kehadiran Rapat</h3></td>
            </tr>
            <tr>
                <td style="vertical-align: middle; " class="text-center"><h6>Dikelola oleh Dinas Komunikasi dan Informatika bidang Aptika</h6></td>
            </tr>
        </thead>
    </table>
    <hr style="height:2px;border-width:0;color:gray;background-color:gray">
    <h4><center>Data Seluruh Rapat pada SIAKRA</center></h4>
